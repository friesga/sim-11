...
{
    InterruptRequest const prio12_0 {TrapPriority::BusError, 0, 0, [] {return 004; }};
    InterruptRequest const prio12_1 {TrapPriority::BusError, 1, 0, [] {return 004; }};
    InterruptRequest const prio12_x {TrapPriority::BusError, 0, 0, [] {return 0;}};

    InterruptRequest const prio10_0 {TrapPriority::TraceTrap, 0, 0, [] {return 014; }};
    InterruptRequest const prio10_1 {TrapPriority::TraceTrap, 1, 0, [] {return 014; }};
...
{
    InterruptRequest const intrptReqA {TrapPriority::BusError, 0, 0, [] {return 004; }};
    InterruptRequest const intrptReqB {TrapPriority::BusError, 0, 0, [] {return 000; }};
...
{
    InterruptRequest const order0 {TrapPriority::BusError, 0, 0, [] {return 004; }};
    InterruptRequest const order1 {TrapPriority::BusError, 0, 1, [] {return 004; }};
