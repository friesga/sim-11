...
{
    DummyCpu dummyCpu;
    OperandLocation operandLocation {RegisterOperandLocation {dummyCpu.cpuData (),
        (u8) 1}};
...
TEST (OperandLocationTest, RegisterOperandLocationCanBeAssignedToOperandLocation)
{
    ...
    RegisterOperandLocation registerOperandLocation {dummyCpu.cpuData (), 1};
    OperandLocation operandLocation;
    operandLocation = registerOperandLocation;
    EXPECT_TRUE (operandLocation.write<u16> (0177777));

    EXPECT_EQ (dummyCpu.cpuData()->registers () [1], 0177777);
}
...
{
    DummyCpu dummyCpu;
    OperandLocation operandLocation {RegisterOperandLocation {dummyCpu.cpuData (), 1}};
    EXPECT_TRUE (operandLocation.write<u16> (0177777));
...
TEST (OperandLocationTest, RegisterLocationWordCanBeRead)
{
    ...
    dummyCpu.cpuData()->registers() [1] = 0177777;
...
TEST (OperandLocationTest, RegisterLocationByteCanBeWritten)
{
    ...
    EXPECT_EQ (dummyCpu.cpuData ()->registers () [1] & 0377, 0377);
}
...
TEST (OperandLocationTest, RegisterLocationByteCanBeRead)
{
    ...
    dummyCpu.cpuData ()->registers() [1] = 0101;
