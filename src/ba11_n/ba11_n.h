...
private:
    ...
    Panel::Frame<float> ba11_nFrontBoundingBox    {0, 0, 1.0, 1.0};
    Panel::Frame<float> pwrOkLedBoundingBox       {0.687, 0.573, 0.016, 0.060};
    Panel::Frame<float> runLedBoundingBox         {0.712, 0.573, 0.016, 0.060};
    Panel::Frame<float> restartSwitchBoundingBox  {0.800, 0.558, 0.027, 0.101};
    Panel::Frame<float> haltSwitchBoundingBox     {0.833, 0.558, 0.027, 0.101};
    Panel::Frame<float> auxOnOffSwitchBoundingBox {0.867, 0.558, 0.027, 0.101};
