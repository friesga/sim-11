...
unique_ptr<LSI11Instruction> KDF11_AInstruction::decode (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
    return decodeGroup_nn_xx_xx (cpuData, cpuControl, mmu, instruction);
}

unique_ptr<LSI11Instruction> KDF11_AInstruction::decodeGroup_00_00_nn (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
    if (instruction <= 07)
...
unique_ptr<LSI11Instruction> KDF11_AInstruction::decodeGroup_00_02_nn (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
...
unique_ptr<LSI11Instruction> KDF11_AInstruction::decodeGroup_07_nx_xx (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
    return (*group_07_nx_xx [(instruction >> 9) - 070]) (cpuData, cpuControl, mmu, instruction);
}

unique_ptr<LSI11Instruction> KDF11_AInstruction::decodeGroup_10_xx_xx (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
    return (*group_10_xx_xx [(instruction >> 6) - 01000]) (cpuData, cpuControl, mmu, instruction);
}

unique_ptr<LSI11Instruction> KDF11_AInstruction::decodeGroup_00_nn_xx (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
    return (*group_00_nn_xx [instruction >> 6]) (cpuData, cpuControl, mmu, instruction);
}

unique_ptr<LSI11Instruction> KDF11_AInstruction::decodeGroup_nn_xx_xx (CpuData* cpuData,
    CpuControl* cpuControl, MMU* mmu, u16 instruction)
{
