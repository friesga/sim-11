...
KDF11_ODT::State KDF11_ODT::StateMachine::transition (AddressOpened_3 &&, CloseLocationCmdEntered)
{
...
KDF11_ODT::State KDF11_ODT::StateMachine::transition (AddressOpened_3 &&, OpenNextLocationCmdEntered)
{
