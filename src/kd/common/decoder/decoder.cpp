...
Instruction Decoder::decode (u16 instruction)
{
...
Instruction Decoder::decodeGroup_00_02_nn (u16 instruction)
{
    return (*group_00_02_nn [instruction - 0200]) (instruction);
}

Instruction Decoder::decodeGroup_07_5n_nx (u16 instruction)
{
...
Instruction Decoder::decodeGroup_07_nx_xx (u16 instruction)
{
    return (*group_07_nx_xx [(instruction >> 9) - 070]) (instruction);
}

Instruction Decoder::decodeGroup_10_xx_xx (u16 instruction)
{
    return (*group_10_xx_xx [(instruction >> 6) - 01000]) (instruction);
}

Instruction Decoder::decodeGroup_00_nn_xx (u16 instruction)
{
    return (*group_00_nn_xx [instruction >> 6]) (instruction);
}

Instruction Decoder::decodeGroup_nn_xx_xx (u16 instruction)
{
