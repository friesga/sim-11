...
//
bool BaseOperandDecoder::isByteInstruction (u16 opCode)
{
...
// operand. The instruction's operation code is needed for the processing
// of the autoincrement and autodecrement addressing modes.
//
	...
	GeneralRegisters& reg)
{
	...
	switch (operand.mode_)
	{
		...
		case 2:
			...
			if (isByteInstruction (opCode) && operand.registerNr_ != 6 &&
