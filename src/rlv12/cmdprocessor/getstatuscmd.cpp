...
u16 CmdProcessor::getStatusCmd (RL01_2 *unit, RLV12Command &rlv12Command)
{
    ...
    // be set.
    if (!(controller_->dar_ & RLV12::DAR_GetStatus))
    {
    ...
    if (controller_->dar_ & RLV12::DAR_Reset)
        unit->driveStatus_ &= 
