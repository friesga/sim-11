...
void KD11CPU::execInstr ()
{
    ...
    switch (insn >> 12)
    {
                ...
                case 00000: 
                    ...
                    switch (insn)
                    {
                        ...
                        case 0000004:
                        {
                            // IOT (this, insn);
                            unique_ptr<LSI11Instruction> instr = 
                                make_unique<KD11_NA::IOT> (static_cast<CpuData*> (this), insn);
                            CpuData::Trap returnedTrap = instr->execute ();
                            if (returnedTrap != CpuData::Trap::None)
                                setTrap (vectorTable [returnedTrap]);
                            break;
        ...
        case 007: 
            ...
            switch (insn >> 9)
            {
                ...
                case 0072:
                {
                    // ASH (this, insn);
                    unique_ptr<LSI11Instruction> instr = 
                        make_unique<KD11_NA::ASH> (static_cast<CpuData*> (this), insn);
                    CpuData::Trap returnedTrap = instr->execute ();
                    if (returnedTrap != CpuData::Trap::None)
                        setTrap (vectorTable [returnedTrap]);
                    break;
                ...
                case 0077:
                {
                    // SOB (this, insn);
                    unique_ptr<LSI11Instruction> instr = 
                        make_unique<KD11_NA::SOB> (static_cast<CpuData*> (this), insn);
                    CpuData::Trap returnedTrap = instr->execute ();
                    if (returnedTrap != CpuData::Trap::None)
                        setTrap (vectorTable [returnedTrap]);
                    break;
        ...
        case 010: 
            ...
            switch (insn >> 6)
            {
                ...
                case 01047:
                {
                    // TRAP (this, insn);
                    unique_ptr<LSI11Instruction> instr = 
                        make_unique<KD11_NA::TRAP> (static_cast<CpuData*> (this), insn);
                    CpuData::Trap returnedTrap = instr->execute ();
                    if (returnedTrap != CpuData::Trap::None)
                        setTrap (vectorTable [returnedTrap]);
                    break;
        ...
        case 014:
        {
            // BICB (this, insn);
            unique_ptr<LSI11Instruction> instr = 
                make_unique<KD11_NA::BICB> (static_cast<CpuData*> (this), insn);
            CpuData::Trap returnedTrap = instr->execute ();
            if (returnedTrap != CpuData::Trap::None)
                setTrap (vectorTable [returnedTrap]);
            break;
