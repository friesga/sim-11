...
// a zero result.
class KD11_NAInstruction::BGT : public BranchInstruction, public WithFactory<BGT>
{
public:
...
KD11_NAInstruction::BGT::BGT (CpuData* cpu, u16 instruction)
    :
    BranchInstruction (cpu, instruction)
{}

CpuData::Trap KD11_NAInstruction::BGT::execute ()
{
