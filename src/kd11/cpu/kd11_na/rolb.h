...
//
class KD11_NA::ROLB : public SingleOperandInstruction, public WithFactory<ROLB>
{
public:
...
KD11_NA::ROLB::ROLB (CpuData* cpu, u16 instruction)
    :
    SingleOperandInstruction (cpu, instruction)
{}

CpuData::Trap KD11_NA::ROLB::execute ()
{
    CondData<u8> source;
