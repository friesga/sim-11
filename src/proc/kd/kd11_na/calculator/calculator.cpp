...
//
double KD11_NA_Calculator::operator() (CLR const& instr) const
{
...
double KD11_NA_Calculator::operator() (CLRB const& instr) const
{
...
double KD11_NA_Calculator::operator() (COM const& instr) const
{
...
double KD11_NA_Calculator::operator() (COMB const& instr) const
{
...
double KD11_NA_Calculator::operator() (INC const& instr) const
{
...
double KD11_NA_Calculator::operator() (INCB const& instr) const
{
...
double KD11_NA_Calculator::operator() (DEC const& instr) const
{
...
double KD11_NA_Calculator::operator() (DECB const& instr) const
{
...
double KD11_NA_Calculator::operator() (NEG const& instr) const
{
...
double KD11_NA_Calculator::operator() (NEGB const& instr) const
{
...
double KD11_NA_Calculator::operator() (TST const& instr) const
{
...
double KD11_NA_Calculator::operator() (TSTB const& instr) const
{
...
double KD11_NA_Calculator::operator() (ASR const& instr) const
{
...
double KD11_NA_Calculator::operator() (ASRB const& instr) const
{
...
double KD11_NA_Calculator::operator() (ASL const& instr) const
{
...
double KD11_NA_Calculator::operator() (ASLB const& instr) const
{
...
double KD11_NA_Calculator::operator() (ROR const& instr) const
{
...
double KD11_NA_Calculator::operator() (RORB const& instr) const
{
...
double KD11_NA_Calculator::operator() (ROL const& instr) const
{
...
double KD11_NA_Calculator::operator() (ROLB const& instr) const
{
...
double KD11_NA_Calculator::operator() (SWAB const& instr) const
{
...
double KD11_NA_Calculator::operator() (ADC const& instr) const
{
...
double KD11_NA_Calculator::operator() (ADCB const& instr) const
{
...
double KD11_NA_Calculator::operator() (SBC const& instr) const
{
...
double KD11_NA_Calculator::operator() (SBCB const& instr) const
{
...
double KD11_NA_Calculator::operator() (SXT const& instr) const
{
...
// of SRC time.
double KD11_NA_Calculator::operator() (MFPS const& instr) const
{
...
double KD11_NA_Calculator::operator() (MTPS const& instr) const
{
...
double KD11_NA_Calculator::operator() (JMP const& instr) const
{
...
double KD11_NA_Calculator::operator() (MARK const& instr) const
{
    return 11.55;
}
...
double KD11_NA_Calculator::operator() (MFPD const& instr) const
{
    return 0.0;
}

double KD11_NA_Calculator::operator() (MFPI const& instr) const
{
    return 0.0;
}

double KD11_NA_Calculator::operator() (MTPD const& instr) const
{
    return 0.0;
}

double KD11_NA_Calculator::operator() (MTPI const& instr) const
{
    return 0.0;
}

// Double operand instructions
double KD11_NA_Calculator::operator() (MOV const& instr) const
{
...
double KD11_NA_Calculator::operator() (MOVB const& instr) const
{
...
double KD11_NA_Calculator::operator() (CMP const& instr) const
{
...
double KD11_NA_Calculator::operator() (CMPB const& instr) const
{
...
double KD11_NA_Calculator::operator() (ADD const& instr) const
{
...
double KD11_NA_Calculator::operator() (SUB const& instr) const
{
...
double KD11_NA_Calculator::operator() (BIT const& instr) const
{
...
double KD11_NA_Calculator::operator() (BITB const& instr) const
{
...
double KD11_NA_Calculator::operator() (BIC const& instr) const
{
...
double KD11_NA_Calculator::operator() (BICB const& instr) const
{
...
double KD11_NA_Calculator::operator() (BIS const& instr) const
{
...
double KD11_NA_Calculator::operator() (BISB const& instr) const
{
...
double KD11_NA_Calculator::operator() (JSR const& instr) const
{
...
// at 40 microseconds.
//
double KD11_NA_Calculator::operator() (MUL const& instr) const
{
    return 40.0;
}
...
double KD11_NA_Calculator::operator() (DIV const& instr) const
{
    return 42.0;
}

double KD11_NA_Calculator::operator() (ASH const& instr) const
{
...
double KD11_NA_Calculator::operator() (ASHC const& instr) const
{
    if (instr.getShiftCount () > 0)
        // Positive is a left shift
...
double KD11_NA_Calculator::operator() (XOR const& instr) const
{
...
// calculation.
double KD11_NA_Calculator::operator() (SOB const& instr) const
{
    return 4.90;
}

// FIS format instructions
double KD11_NA_Calculator::operator() (RTS const& instr) const
{
    return 5.25;
}
...
double KD11_NA_Calculator::operator() (FADD const& instr) const
{
    return 75.0;
}

// See comment on FADD
double KD11_NA_Calculator::operator() (FSUB const& instr) const
{
    return 75.0;
}
...
// will hold for FMUL.
double KD11_NA_Calculator::operator() (FMUL const& instr) const
{
    return 151.0;
}

// Typical execution time for FDIV is 151 microseconds.
double KD11_NA_Calculator::operator() (FDIV const& instr) const
{
    return 151.0;
}
...
double KD11_NA_Calculator::operator() (BR const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BNE const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BEQ const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BPL const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BMI const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BVC const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BVS const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BCC const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BCS const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BGE const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BLT const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BGT const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BLE const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BHI const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculator::operator() (BLOS const& instr) const
{
    return 3.50;
}
...
double KD11_NA_Calculator::operator() (EMT const& instr) const
{
    return 16.80;
}

// See comment on EMT above.
double KD11_NA_Calculator::operator() (TRAP const& instr) const
{
    return 16.80;
}

// No-operand instructions
double KD11_NA_Calculator::operator() (HALT const& instr) const
{
    return 5.60;
}

double KD11_NA_Calculator::operator() (WAIT const& instr) const
{
    return 6.30;
}

// See comment on EMT instruction above.
double KD11_NA_Calculator::operator() (RTI const& instr) const
{
    return 8.75;
}
...
double KD11_NA_Calculator::operator() (BPT const& instr) const
{
    return 18.55;
}

// See comment on EMT instruction above.
double KD11_NA_Calculator::operator() (IOT const& instr) const
{
    return 18.55;
}

// A RESET takes 5.95 + 10.0 microsec. for INIT + 90.0 microsec.
double KD11_NA_Calculator::operator() (RESET const& instr) const
{
    return 105.95;
}
...
double KD11_NA_Calculator::operator() (RTT const& instr) const
{
    return 8.75;
}

// All clear condition code instructions are executed in 3.50 microseconds.
double KD11_NA_Calculator::operator() (CCC const& instr) const
{
    return 3.50;
}

// All set condition code instructions are executed in 3.50 microseconds.
double KD11_NA_Calculator::operator() (SCC const& instr) const
{
    return 3.50;
}

// The MFPY instruction is not supported on the KD11-NA.
double KD11_NA_Calculator::operator() (MFPT const& instr) const
{
    return 0.0;
}
...
double KD11_NA_Calculator::operator() (Unused const& instr) const
{
    return 0.0;
}