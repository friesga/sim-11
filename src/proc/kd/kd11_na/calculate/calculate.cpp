...
//
double KD11_NA_Calculate::operator() (CLR const& instr) const
{
...
double KD11_NA_Calculate::operator() (CLRB const& instr) const
{
...
double KD11_NA_Calculate::operator() (COM const& instr) const
{
...
double KD11_NA_Calculate::operator() (COMB const& instr) const
{
...
double KD11_NA_Calculate::operator() (INC const& instr) const
{
...
double KD11_NA_Calculate::operator() (INCB const& instr) const
{
...
double KD11_NA_Calculate::operator() (DEC const& instr) const
{
...
double KD11_NA_Calculate::operator() (DECB const& instr) const
{
...
double KD11_NA_Calculate::operator() (NEG const& instr) const
{
...
double KD11_NA_Calculate::operator() (NEGB const& instr) const
{
...
double KD11_NA_Calculate::operator() (TST const& instr) const
{
...
double KD11_NA_Calculate::operator() (TSTB const& instr) const
{
...
double KD11_NA_Calculate::operator() (ASR const& instr) const
{
...
double KD11_NA_Calculate::operator() (ASRB const& instr) const
{
...
double KD11_NA_Calculate::operator() (ASL const& instr) const
{
...
double KD11_NA_Calculate::operator() (ASLB const& instr) const
{
...
double KD11_NA_Calculate::operator() (ROR const& instr) const
{
...
double KD11_NA_Calculate::operator() (RORB const& instr) const
{
...
double KD11_NA_Calculate::operator() (ROL const& instr) const
{
...
double KD11_NA_Calculate::operator() (ROLB const& instr) const
{
...
double KD11_NA_Calculate::operator() (SWAB const& instr) const
{
...
double KD11_NA_Calculate::operator() (ADC const& instr) const
{
...
double KD11_NA_Calculate::operator() (ADCB const& instr) const
{
...
double KD11_NA_Calculate::operator() (SBC const& instr) const
{
...
double KD11_NA_Calculate::operator() (SBCB const& instr) const
{
...
double KD11_NA_Calculate::operator() (SXT const& instr) const
{
...
// of SRC time.
double KD11_NA_Calculate::operator() (MFPS const& instr) const
{
...
double KD11_NA_Calculate::operator() (MTPS const& instr) const
{
...
double KD11_NA_Calculate::operator() (JMP const& instr) const
{
...
double KD11_NA_Calculate::operator() (MARK const& instr) const
{
    return 11.55;
}
...
double KD11_NA_Calculate::operator() (MFPD const& instr) const
{
    return 0.0;
}

double KD11_NA_Calculate::operator() (MFPI const& instr) const
{
    return 0.0;
}

double KD11_NA_Calculate::operator() (MTPD const& instr) const
{
    return 0.0;
}

double KD11_NA_Calculate::operator() (MTPI const& instr) const
{
    return 0.0;
}

// Double operand instructions
double KD11_NA_Calculate::operator() (MOV const& instr) const
{
...
double KD11_NA_Calculate::operator() (MOVB const& instr) const
{
...
double KD11_NA_Calculate::operator() (CMP const& instr) const
{
...
double KD11_NA_Calculate::operator() (CMPB const& instr) const
{
...
double KD11_NA_Calculate::operator() (ADD const& instr) const
{
...
double KD11_NA_Calculate::operator() (SUB const& instr) const
{
...
double KD11_NA_Calculate::operator() (BIT const& instr) const
{
...
double KD11_NA_Calculate::operator() (BITB const& instr) const
{
...
double KD11_NA_Calculate::operator() (BIC const& instr) const
{
...
double KD11_NA_Calculate::operator() (BICB const& instr) const
{
...
double KD11_NA_Calculate::operator() (BIS const& instr) const
{
...
double KD11_NA_Calculate::operator() (BISB const& instr) const
{
...
double KD11_NA_Calculate::operator() (JSR const& instr) const
{
...
// at 40 microseconds.
//
double KD11_NA_Calculate::operator() (MUL const& instr) const
{
    return 40.0;
}
...
double KD11_NA_Calculate::operator() (DIV const& instr) const
{
    return 42.0;
}

double KD11_NA_Calculate::operator() (ASH const& instr) const
{
...
double KD11_NA_Calculate::operator() (ASHC const& instr) const
{
    if (instr.getShiftCount () > 0)
        // Positive is a left shift
...
double KD11_NA_Calculate::operator() (XOR const& instr) const
{
...
// calculation.
double KD11_NA_Calculate::operator() (SOB const& instr) const
{
    return 4.90;
}

// FIS format instructions
double KD11_NA_Calculate::operator() (RTS const& instr) const
{
    return 5.25;
}
...
double KD11_NA_Calculate::operator() (FADD const& instr) const
{
    return 75.0;
}

// See comment on FADD
double KD11_NA_Calculate::operator() (FSUB const& instr) const
{
    return 75.0;
}
...
// will hold for FMUL.
double KD11_NA_Calculate::operator() (FMUL const& instr) const
{
    return 151.0;
}

// Typical execution time for FDIV is 151 microseconds.
double KD11_NA_Calculate::operator() (FDIV const& instr) const
{
    return 151.0;
}
...
double KD11_NA_Calculate::operator() (BR const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BNE const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BEQ const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BPL const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BMI const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BVC const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BVS const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BCC const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BCS const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BGE const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BLT const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BGT const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BLE const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BHI const& instr) const
{
    return 3.50;
}

double KD11_NA_Calculate::operator() (BLOS const& instr) const
{
    return 3.50;
}
...
double KD11_NA_Calculate::operator() (EMT const& instr) const
{
    return 16.80;
}

// See comment on EMT above.
double KD11_NA_Calculate::operator() (TRAP const& instr) const
{
    return 16.80;
}

// No-operand instructions
double KD11_NA_Calculate::operator() (HALT const& instr) const
{
    return 5.60;
}

double KD11_NA_Calculate::operator() (WAIT const& instr) const
{
    return 6.30;
}

// See comment on EMT instruction above.
double KD11_NA_Calculate::operator() (RTI const& instr) const
{
    return 8.75;
}
...
double KD11_NA_Calculate::operator() (BPT const& instr) const
{
    return 18.55;
}

// See comment on EMT instruction above.
double KD11_NA_Calculate::operator() (IOT const& instr) const
{
    return 18.55;
}

// A RESET takes 5.95 + 10.0 microsec. for INIT + 90.0 microsec.
double KD11_NA_Calculate::operator() (RESET const& instr) const
{
    return 105.95;
}
...
double KD11_NA_Calculate::operator() (RTT const& instr) const
{
    return 8.75;
}

// All clear condition code instructions are executed in 3.50 microseconds.
double KD11_NA_Calculate::operator() (CCC const& instr) const
{
    return 3.50;
}

// All set condition code instructions are executed in 3.50 microseconds.
double KD11_NA_Calculate::operator() (SCC const& instr) const
{
    return 3.50;
}

// The MFPY instruction is not supported on the KD11-NA.
double KD11_NA_Calculate::operator() (MFPT const& instr) const
{
    return 0.0;
}
...
double KD11_NA_Calculate::operator() (Unused const& instr) const
{
    return 0.0;
}