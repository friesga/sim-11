#include "kdf11_executionengine.h"
...
// Constructor
KDF11_ExecutionEngine::KDF11_ExecutionEngine (Bus* bus, CpuData* cpuData, MMU* mmu,
...
void KDF11_ExecutionEngine::cpuReset ()
{
...
// the KTF11-A.
void KDF11_ExecutionEngine::busReset ()
{
    bus_->BINIT().cycle ();
    mmu_->reset ();
}
...
// Halt the processor
void KDF11_ExecutionEngine::halt ()
{
    runState = CpuControl::CpuRunState::HALT;
    haltReason_ = CpuControl::HaltReason::HaltInstruction;
    bus_->SRUN().set (false);
...
void KDF11_ExecutionEngine::wait ()
{
...
void KDF11_ExecutionEngine::start (u16 address)
{
...
void KDF11_ExecutionEngine::proceed ()
{
    runState = CpuControl::CpuRunState::RUN;
    bus_->SRUN().set (true);
...
//
CpuControl::CpuRunState KDF11_ExecutionEngine::execute ()
{
...
void KDF11_ExecutionEngine::execInstr ()
{
...
void KDF11_ExecutionEngine::serviceTrap ()
{
...
void KDF11_ExecutionEngine::serviceInterrupt ()
{
...
u8 KDF11_ExecutionEngine::cpuPriority ()
{
...
bool KDF11_ExecutionEngine::fetchFromVector (u16 address, u16* dest)
{
...
void KDF11_ExecutionEngine::swapPcPSW (u16 vectorAddress)
{
...
void KDF11_ExecutionEngine::traceStep ()
{
    trace.setIgnoreBus ();
    u16 code[3];
