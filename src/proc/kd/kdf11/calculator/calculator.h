#ifndef _KDF11_CALCULATOR_H_
#define _KDF11_CALCULATOR_H_

#include "proc/common/addressingmodetimes/addressingmodetimes.h"
#include "proc/kd/kdf11/calculator/kdf11_addressingmodetime.h"
