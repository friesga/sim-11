...
// state is taken when initialization of KDF11_ODT is complete. This prevents
// that actions on the entry of AtPrompt_1, such as writing characters to
// the DLV11J are executed before KDF11_ODT is initialized and there is no valid
...
//
KDF11_ODT::State KDF11_ODT::StateMachine::transition (EntryPoint &&, StartFsm)
{
