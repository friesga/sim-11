#ifndef _RLV12REGISTERSRECORD_H_
#define _RLV12REGISTERSRECORD_H_
...
template <>
class TraceRecord<RLV12RegistersRecord>
{
...
inline TraceRecord<RLV12RegistersRecord>::TraceRecord ()
	:
    rlcs_ {0},
    rlba_ {0},
    rlda_ {0},
...
inline TraceRecord<RLV12RegistersRecord>::TraceRecord (string msg, u16 rlcs,
...
#endif // _RLV12REGISTERSRECORD_H_