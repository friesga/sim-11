...
template <>
class TraceRecord<TraceCpu>
{
	friend std::ostream& operator<< (std::ostream& os, 
		TraceRecord<TraceCpu> record);
...
inline TraceRecord<TraceCpu>::TraceRecord ()
	:
	r_ {},
	psw_ {0},
	insn_ {0}
...
inline TraceRecord<TraceCpu>::TraceRecord (u16 r[], u16 psw, u16 insn[])
	:
	psw_ {psw}
{
