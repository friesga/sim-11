#ifndef _RXV21DISKRECORD_H_
#define _RXV21DISKRECORD_H_
...
template <>
class TraceRecord<RXV21DiskRecord>
{
    friend std::ostream& operator<< (std::ostream& os, 
        TraceRecord<RXV21DiskRecord> record);
...
// Constructors for the TraceRecord<RXV21DiskRecord> type
inline TraceRecord<RXV21DiskRecord>::TraceRecord ()
	:
...
inline TraceRecord<RXV21DiskRecord>::TraceRecord (RXV21DiskCmd type, u8 drive,
