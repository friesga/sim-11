...
class TraceRecord<MemoryDump>
{
    ...
    //    from the TraceRecord<MemoryDump> constructor to the function
...
inline TraceRecord<MemoryDump>::TraceRecord ()
	:
    address_ {0},
    length_ {0},
    ptr_ {nullptr}
...
inline TraceRecord<MemoryDump>::TraceRecord (u8 *ptr, u16 address, u16 length)
	:
    address_ {address},
    length_ {length}
{
