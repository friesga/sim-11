...
void SDLRenderer::copyCircle (SDLTexture& texture,
...
int SDLRenderer::drawCircle (Position position, int radius)
{
...
int SDLRenderer::fillCircle (int x, int y, int radius)
{
    int offsetx, offsety, d;
    int status;
